  ...
  <main>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active px-2" aria-current="page" href="index_logged.php">Home</a>
            </li>
            <li class="nav-item px-2">
              <a class="nav-link" href="index_logged.php#services_description">What we do?</a>
            </li>
            <li class="nav-item px-2">
              <a class="nav-link" href="index_logged.php#contact">Contact</a>
            </li>
          </div>
          <h5 style="color:aliceblue" class="nav-item px-2">Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to our site.</h5>
    <p>
